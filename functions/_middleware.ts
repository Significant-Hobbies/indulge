// CF Pages Functions middleware for indulge.significanthobbies.com (Indulge):
...
const SITE_URL = "https://indulge.significanthobbies.com";

const OPENAPI_SPEC = {
  openapi: "3.1.0",
  info: {
    title: "Indulge public API",
    version: "1.0.0",
    description:
      "Indulge is a private, local-first iPhone app for keeping the pleasures you choose, reclaiming time that runs longer than intended, and making room for more of the life you want. The public web API exposes read-only agent surfaces: the agent catalog, sitemap, llms.txt, and per-page markdown alternates.",
    contact: { name: "Indulge", url: SITE_URL },
  },
...
\`${path}\` does not exist on indulge.significanthobbies.com.
